...
namespace ClothesShop.UnitTests
{
    ...
    public class CartTests
    {
        ...
        public void Can_Add_New_Lines()
        {
            ...
            Product item1 = new Product { Id = 1, Name = "Игра1" };
            Product item2 = new Product { Id = 2, Name = "Игра2" };
        ...
        {
            // Организация - создание нескольких тестовых игр
            Product game1 = new Product { Id = 1, Name = "Игра1" };
            Product game2 = new Product { Id = 2, Name = "Игра2" };
            ...
            List<CartLine> results = cart.Lines.OrderBy(c => c.Item.Id).ToList();
        ...
        public void Can_Remove_Line()
        {
            ...
            Product game1 = new Product { Id = 1, Name = "Игра1" };
            Product game2 = new Product { Id = 2, Name = "Игра2" };
            Product game3 = new Product { Id = 3, Name = "Игра3" };
            ...
            // Утверждение
            Assert.AreEqual(cart.Lines.Where(c => c.Item == game2).Count(), 0);
        ...
        {
            // Организация - создание нескольких тестовых игр
            Product game1 = new Product { Id = 1, Name = "Игра1", Price = 100 };
            Product game2 = new Product { Id = 2, Name = "Игра2", Price = 55 };
